...
return [
    ...
    */
    ...
    'morph_type' => env('SEQUENCER_MORPH_TYPE', 'string'),
    ...
    */
    ...
    'execution' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | These settings control the atomic lock mechanism used with --isolated
    ...
    |--------------------------------------------------------------------------
    |
    | Guards control WHETHER operations should execute based on runtime
    | conditions. Unlike strategies (which control HOW operations execute),
    | guards act as gatekeepers that can block execution entirely.
    |
    | If any guard returns false, no operations will execute and an
    | appropriate message will be displayed.
    |
    | Each guard specifies a class (FQCN) and optional config array.
    | All guard classes must implement Cline\Sequencer\Contracts\ExecutionGuard.
    |
    | Built-in guards:
    | - Cline\Sequencer\Guards\HostnameGuard   : Restrict to specific hostnames
    | - Cline\Sequencer\Guards\IpAddressGuard  : Restrict to specific IPs/CIDRs
    |
    ...
    |         'config' => ['allowed' => ['hel2', 'hel3']],
    |     ],
    |     [
    |         'driver' => Cline\Sequencer\Guards\IpAddressGuard::class,
    |         'config' => ['allowed' => ['10.0.0.0/8', '192.168.1.100']],
    |     ],
    |     [
    |         'driver' => App\Guards\MaintenanceWindowGuard::class,
    |         'config' => ['start' => '02:00', 'end' => '04:00'],
    |     ],
    | ],
    |
    */
