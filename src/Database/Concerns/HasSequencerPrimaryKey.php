...
trait HasSequencerPrimaryKey
{
     ...
     *
     * @throws InvalidUuidPrimaryKeyValueException When a manually-set UUID value is not a string
     * @throws InvalidUlidPrimaryKeyValueException When a manually-set ULID value is not a string
     */
    protected static function bootHasSequencerPrimaryKey(): void
    {
        static::creating(function (Model $model): void {
            ...
            if ($primaryKey->type === PrimaryKeyType::UUID && !is_string($existingValue)) {
                throw InvalidUuidPrimaryKeyValueException::fromValue($existingValue);
            }

            if ($primaryKey->type === PrimaryKeyType::ULID && !is_string($existingValue)) {
                throw InvalidUlidPrimaryKeyValueException::fromValue($existingValue);
            }
        });
    }
}
