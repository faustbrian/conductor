...
PHP;
            ...
            // Act
            $orchestrator = resolve(ScheduledOrchestrator::class);
...
PHP;
    ...
    describe('Skip Operation Exception', function (): void {
        test('operation throwing OperationSkippedException is marked as skipped', function (): void {
            // Arrange
...
PHP;
            ...
            // Assert: OperationSkipped event dispatched (not OperationEnded)
            Event::assertDispatched(OperationSkipped::class);
...
return new class() implements Operation, Rollbackable {
    ...
    public function rollback(): void {
        throw \Tests\Support\Exceptions\TestException::rollbackFailed();
    }
};
PHP;
